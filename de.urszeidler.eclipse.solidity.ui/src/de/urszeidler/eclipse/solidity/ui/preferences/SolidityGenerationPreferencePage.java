...
public class SolidityGenerationPreferencePage
	...
	public void createFieldEditors() {
		addField(new StringFieldEditor(PreferenceConstants.GENERATION_TARGET, "generate to directory", -1, StringFieldEditor.VALIDATE_ON_KEY_STROKE, getFieldEditorParent()));
